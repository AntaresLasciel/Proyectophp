...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2023 a las 00:36:31
...
INSERT INTO `clientes` (`id_cl`, `nombre_cl`, `apellido_cl`, `correo_cl`, `ciudad_cl`, `direccion_cl`, `admin`, `password`) VALUES
('11111', 'jonathan', 'perez', 'jonathan@test.com', 'medellin', 'cl 42', NULL, '12345'),
('15667', 'angel', 'hidalgo', 'angelh@hddhdh-cm', 'madrid', 'cl 2', 1, '12345'),
('33333', 'jesus', 'perez', 'hghghg@hdhdh.com', 'medellin', 'cl4', NULL, '12345');
...
(6, '11111', '200', 3, '0000-00-00'),
(8, '15667', '200', 3, '0000-00-00'),
(9, '15667', '200', 3, '0000-00-00'),
(10, '15667', '200', 3, '0000-00-00'),
(88, '15667', '200', 3, '0000-00-00'),
(89, '15667', '200', 3, '0000-00-00'),
(90, '15667', '200', 3, '0000-00-00'),
(91, '15667', '200', 3, '2023-10-29'),
(92, '15667', '200', 3, '2023-10-29'),
(93, '15667', '200', 3, '2023-10-29');
...
--
ALTER TABLE `pedido`
  MODIFY `Num_Pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `pedido_ibfk_4` FOREIGN KEY (`id_cl`) REFERENCES `clientes` (`id_cl`) ON DELETE NO ACTION ON UPDATE CASCADE;
